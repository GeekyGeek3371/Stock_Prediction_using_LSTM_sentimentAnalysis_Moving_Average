...
fb = get_adj_close('infy.ns', '1/2/2018', '11/1/2020')
tesla = get_adj_close('infy.ns', '1/2/2018', '11/1/2020')
amazon = get_adj_close('amzn', '1/2/2018', '11/1/2020')
...
print(item['Upper Band'].tail(5),item['Lower Band'].tail(5),item['Adj Close'].tail(5))
up = len(item['Upper Band'])
print(up)
print(item['Upper Band'][695])
mabs=0          #buy or sell for this
if( item['30 Day MA'][695] + item['30 Day STD'][695] < item['Adj Close'][695]  < item['Upper Band'][695] ):
    print("BUY")
    mabs=1

elif(  item['Lower Band'][695] < item['Adj Close'][695] < item['30 Day MA'][695] - item['30 Day STD'][695] ):
    print("SELL")
    mabs=-1
else:
    mabs=0
